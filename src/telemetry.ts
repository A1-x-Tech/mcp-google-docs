 ...
 * environment versions ever leave the machine. The OAuth credentials, document
 * content, tool arguments, prompts and the names or values of environment
 ...
 * (a malformed setup such as a partial OAuth triple); `unconfigured_start` is
 * its live counterpart — the server survives missing credentials and completes
